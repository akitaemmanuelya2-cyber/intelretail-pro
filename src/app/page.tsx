    ...
    <div className="flex min-h-screen bg-transparent text-[#F3F4F6] relative overflow-hidden">
      ...
      >
        ...
        <div className="p-3.5 rounded-xl bg-[#0C1519]/70 border border-[#724B39]/40 space-y-2.5">
          ...
          {/* Switch de Conversión con Tooltip solicitado */}
          <div className="pt-1">
        ...
        <div className="p-3.5 rounded-xl bg-[#0C1519]/70 border border-[#724B39]/40 space-y-3">
          ...
          <div className="border border-[#724B39]/40 rounded-lg overflow-hidden">
            <button
              ...
              className="w-full p-2 bg-[#162127] flex justify-between items-center text-xs font-semibold text-[#D1D5DB]"
            >
            ...
            {requirementsOpen && (
              <div className="p-2.5 bg-[#0C1519] text-[11px] text-[#D1D5DB]/80 space-y-1">
      ...
      >
        ...
        {screen === 'express' && (
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="glass-card p-6 rounded-2xl space-y-4">
              <h3 className="text-xs font-bold uppercase tracking-wider text-[#CF9D7B]">1. Ingresos Semanales (8 Semanas)</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div className="glass-card p-5 rounded-2xl space-y-3">
                <label className="text-xs font-bold text-[#CF9D7B] uppercase">Margen Neto Promedio: {marginAvg}%</label>
                <input
                  type="range"
                  min="5"
                  max="90"
              ...
              <div className="glass-card p-5 rounded-2xl space-y-1">
                <label className="text-xs font-bold text-[#CF9D7B] uppercase">Gastos Fijos Acumulados (2 Meses)</label>
                <input
                  type="number"
                  value={fixedCosts}
              ...
              <div className="glass-card p-5 rounded-2xl space-y-1">
                <label className="text-xs font-bold text-[#CF9D7B] uppercase">Atenciones/Clientes (8 Semanas)</label>
                <input
                  type="number"
          ...
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            {dataset.length === 0 ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="glass-card p-5 rounded-2xl space-y-3">
                    <h4 className="text-xs font-bold text-[#CF9D7B] uppercase">Exportación de Reportes</h4>
                    <div className="flex space-x-3">
                      <button
                        onClick={downloadAuditExcel}
                        className="btn-interactive flex-1 py-2 px-3 rounded-lg text-[#CF9D7B] text-xs font-bold"
                      >
                        Excel (.xlsx)
                      </button>
                      <button
                        onClick={downloadAuditTextReport}
                        className="btn-interactive flex-1 py-2 px-3 rounded-lg text-xs font-bold text-[#CF9D7B]"
                      >
                        Informe Texto (.txt)
                      </button>
                    </div>
                  ...
                  <div className="glass-card p-5 rounded-2xl space-y-3">
                    <h4 className="text-xs font-bold text-[#CF9D7B] uppercase">Análisis Estratégico IA</h4>
                    <button
                      onClick={() =>
                        handleSendMessage(
                      ...
                      className="btn-interactive w-full py-2.5 px-3 rounded-lg text-[#CF9D7B] font-bold text-xs flex items-center justify-center space-x-2"
                    >
                      <Sparkles className="w-4 h-4 text-[#CF9D7B]" />
                ...
                <div className="glass-card p-6 rounded-2xl space-y-3">
                  <h3 className="text-xs font-bold text-[#CF9D7B] uppercase">3. Matriz BCG: Rentabilidad vs. Rotación</h3>
                  <div className="h-64 w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                        ...
                        <Tooltip cursor={{ strokeDasharray: '3 3' }} contentStyle={{ backgroundColor: '#162127', borderColor: '#724B39', borderRadius: '8px' }} />
                        <Scatter name="Productos" data={datasetTotals?.groupedList || []} fill="#CF9D7B" />
                      </ScatterChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                ...
                {/* 4. Análisis Profundo */}
                <div className="glass-card p-6 rounded-2xl space-y-4">
                  <h3 className="text-xs font-bold text-[#CF9D7B] uppercase">4. Análisis Profundo del Negocio</h3>
                      ...
                      <BarChart layout="vertical" data={deepAnalysisData} margin={{ top: 10, right: 30, left: 140, bottom: 10 }}>
                        ...
                        <Bar dataKey="value" radius={[0, 6, 6, 0]}>
                          {deepAnalysisData.map((_, index) => {
                            const colors = ['#CF9D7B', '#724B39', '#3A3534', '#162127', '#8C5D45'];
        ...
        {/* PANTALLA: PLANIFICADOR (Título limpio sin 'Modo Dios') */}
        {screen === 'planner' && (
          <div className="max-w-5xl mx-auto space-y-6">
            <div>
